 ...
 */
public class SelectorCheckBox extends CheckBox implements BackgroundSelector{
    ...
    public SelectorCheckBox(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
