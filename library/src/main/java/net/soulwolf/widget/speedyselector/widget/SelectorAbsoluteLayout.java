 ...
 */
public class SelectorAbsoluteLayout extends AbsoluteLayout implements BackgroundSelector{

    SpeedySelectorDelegate mSpeedySelectorDelegate;

    public SelectorAbsoluteLayout(Context context) {
        super(context);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this);
    }

    public SelectorAbsoluteLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this,attrs);
    }

    public SelectorAbsoluteLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this,attrs,defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SelectorAbsoluteLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
