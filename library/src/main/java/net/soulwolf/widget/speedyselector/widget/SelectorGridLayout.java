...
public class SelectorGridLayout extends GridLayout implements BackgroundSelector{

    SpeedySelectorDelegate mSpeedySelectorDelegate;

    public SelectorGridLayout(Context context) {
        super(context);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this);
    }

    public SelectorGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this,attrs);
    }

    public SelectorGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this,attrs,defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SelectorGridLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
