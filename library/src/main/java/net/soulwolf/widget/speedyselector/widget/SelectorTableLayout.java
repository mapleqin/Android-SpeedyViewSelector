 ...
 */
public class SelectorTableLayout extends TableLayout implements BackgroundSelector{

    SpeedySelectorDelegate mSpeedySelectorDelegate;

    public SelectorTableLayout(Context context) {
        super(context);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtain(this);
    }

    public SelectorTableLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
