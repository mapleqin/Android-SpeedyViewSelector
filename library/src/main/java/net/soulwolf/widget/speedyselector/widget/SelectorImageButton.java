 ...
 */
public class SelectorImageButton extends ImageButton implements BackgroundSelector{
    ...
    public SelectorImageButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
