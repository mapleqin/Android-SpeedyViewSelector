 ...
 */
public class SelectorEditText extends EditText implements GeneralSelector{
    ...
    public SelectorEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mSpeedySelectorDelegate = SpeedySelectorDelegate.obtainGeneral(this, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SelectorEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
